...
<c:set var="pageTitle" value="Gestion des Avis - SmartSpace System" scope="request"/>
...
<div class="page-header">
    <div class="page-title-section">
        ...
        <div class="page-title">
            ...
            <p>Consultez et modérez les avis sur les espaces</p>
        </div>
    </div>
</div>
    ...
    <c:choose>
        <c:when test="${empty avis}">
            <div class="empty-state">
                ...
                <p>Les utilisateurs n'ont pas encore laissé d'avis sur les espaces.</p>
            </div>
        </c:when>
        <c:otherwise>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="cell-with-icon">
                                    ...
                                    <span class="cell-text">${a.bienNom}</span>
                                </div>
                            </td>
                            <td>
                                <div class="cell-with-icon">
