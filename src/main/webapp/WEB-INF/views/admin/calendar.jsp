...
<c:set var="pageTitle" value="Calendrier Biens - SmartSpace System" scope="request"/>
...
<div class="page-header">
    <div class="page-title-section">
        ...
        <div class="page-title">
            <h1>Calendrier par local</h1>
            <p>Visualisez les réservations de chaque espace</p>
        </div>
    </div>
</div>
    ...
    <form method="get" action="${pageContext.request.contextPath}/admin/calendar" class="filter-form">
        <div class="filter-group">
            <label for="bienId">
                ...
                Sélectionner une espace
            </label>
            <select id="bienId" name="bienId" class="filter-select" required>
                <option value="">-- Choisir une espace --</option>
                <c:forEach var="s" items="${biens}">
                    <option value="${s.id}"
                        <c:if test="${selectedBien != null && selectedBien.id == s.id}">selected</c:if>>
...
<c:if test="${selectedBien != null}">
    ...
    <div class="room-info-bar">
        ...
        <div class="week-nav">
            <a href="${pageContext.request.contextPath}/admin/calendar?bienId=${selectedBien.id}&startDate=${prevWeek}" 
               class="btn-nav">
                <i class="fas fa-chevron-left"></i>
                Semaine précédente
            </a>
            <a href="${pageContext.request.contextPath}/admin/calendar?bienId=${selectedBien.id}&startDate=${nextWeek}" 
               class="btn-nav">
                Semaine suivante
