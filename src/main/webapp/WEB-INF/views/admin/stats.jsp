...
<c:set var="pageTitle" value="Statistiques - SmartSpace System" scope="request"/>
...
<div class="page-header">
    <div class="page-title-section">
        ...
        <div class="page-title">
            <h1>Statistiques</h1>
            <p>Analysez l'utilisation des espaces et les tendances de réservation</p>
        </div>
    </div>
</div>
...
<div class="content-grid">
    ...
    <div class="content-card">
        <div class="content-card-header">
            ...
            <h3>Top 5 des espaces les plus réservées</h3>
        </div>
        <c:choose>
            <c:when test="${empty topBiens}">
