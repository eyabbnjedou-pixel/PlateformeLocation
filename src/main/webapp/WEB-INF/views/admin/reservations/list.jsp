...
<c:set var="pageTitle" value="Gestion Réservations - SmartSpace System" scope="request"/>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    input.addEventListener('input', function() {
        ...
        rows.forEach(function(row) {
            ...
            const bienCell = row.querySelector('td:nth-child(2)');
            if (!bienCell) return;

            const text = bienCell.textContent.toLowerCase();
