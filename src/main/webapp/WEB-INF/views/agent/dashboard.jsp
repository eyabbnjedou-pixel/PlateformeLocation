...
<div class="actions-grid">
    <a href="${pageContext.request.contextPath}/admin/biens" class="action-card">
        ...
        <div class="action-content">
            <h3 class="action-title">Espaces</h3>
            <p class="action-description">Ajouter, modifier et gérer les espaces de réunion</p>
    ...
    <a href="${pageContext.request.contextPath}/admin/calendar" class="action-card">
        ...
        <div class="action-content">
            ...
            <p class="action-description">Vue calendrier des réservations par espace</p>
            <span class="action-link">
    ...
    <a href="${pageContext.request.contextPath}/admin/avis" class="action-card">
        ...
        <div class="action-content">
            ...
            <p class="action-description">Consulter et modérer les avis sur les espaces</p>
            <span class="action-link">
                Gérer <i class="fas fa-arrow-right"></i>
            </span>
        </div>
