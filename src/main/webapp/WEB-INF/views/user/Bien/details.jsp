...
<c:set var="pageTitle" value="Détails Biens - SmartSpace System" scope="request"/>
        ...
        <div class="room-info-content">
            ...
            <div class="room-details-list">
                <div class="room-detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="detail-value">${bien.capacite} personnes</div>
                    </div>
                </div>
                ...
                <div class="room-detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="detail-value">${bien.localisation}</div>
                    </div>
                </div>
                ...
                <div class="room-detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="equipment-tags">
                            <c:forTokens items="${bien.equipements}" delims="," var="equip">
            ...
            <div class="rating-section">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <p class="no-rating">Pas encore de note pour cette espace</p>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
                ...
                <c:choose>
                    <c:when test="${empty avisList}">
                        <div class="empty-reviews">
                            ...
                            <p>Aucun avis pour cette espace</p>
