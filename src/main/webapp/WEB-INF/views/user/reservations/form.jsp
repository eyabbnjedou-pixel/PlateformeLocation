...
<c:set var="pageTitle" value="Nouvelle Réservation - SmartSpace System" scope="request"/>
...
<div class="form-page-container">
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <p>Réservez une espace en quelques clics</p>
        </div>
                ...
                <div class="form-group">
                    ...
                    <select id="salleId" name="salleId" class="form-select" required>
                        ...
                        <c:forEach var="s" items="${salles}">
                            <option value="${s.id}" <c:if test="${s.id == BienIdParam}">selected</c:if>>
                    ...
                    <p class="help-text">
                        ...
                        Sélectionnez l'espace que vous souhaitez réserver
                    </p>
                </div>
